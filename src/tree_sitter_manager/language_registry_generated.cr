...
# Generated: 2026-07-08 08:34:37 UTC
...
module TreeSitterManager
  module LanguageRegistryGenerated
    ...
    ] of NamedTuple(name: String, extensions: Array(String), git_url: String, git_rev: String, ffi_func: String, c_symbol: String?, directory: String?, abi_version: Int64?, generate: Bool, nvim_like: Bool, has_injections: Bool, has_locals: Bool)
  end
end
